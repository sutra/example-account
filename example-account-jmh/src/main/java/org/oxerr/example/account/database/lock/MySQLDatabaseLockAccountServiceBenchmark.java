...
public class MySQLDatabaseLockAccountServiceBenchmark implements AutoCloseable {
	...
	public MySQLDatabaseLockAccountServiceBenchmark() {
	...
	public static void main(String[] args) {
		Logger log = LogManager.getLogger(MySQLDatabaseLockAccountServiceBenchmark.class);

		try (final var benchmark = new MySQLDatabaseLockAccountServiceBenchmark()) {
